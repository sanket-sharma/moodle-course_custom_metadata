...
class category_form extends moodleform {
    ...
    function definition () {
        ...
        $mform->addElement('text', 'name', get_string('coursemetadatacategoryname', 'admin'), 'maxlength="255" size="30"');
...
/// perform some moodle validation
    function validation($data, $files) {
        ...
        if ($dupfound ) {
            $errors['name'] = get_string('coursemetadatacategorynamenotunique', 'admin');
        }
